        ...
        <div className="relative flex-1">
          ...
          <div className="flex flex-col items-stretch justify-between pt-4 md:flex-row md:gap-4">
            ...
            <div className="flex flex-col justify-center bg-gradient-to-r from-black px-4 py-6 md:w-[55%] md:py-8 md:pl-12">
              ...
              <p className="pt-6 text-xl text-white">{overview}</p>
            </div>
          ...
          <div className="space-y-4 rounded-r-lg bg-gradient-to-r from-black to-sky-600 px-6 py-6 text-lg font-semibold text-white shadow-lg md:w-[60%] md:px-12 lg:w-[45%]">
            ...
            <div className="flex justify-between">
              ...
              <div className="text-white">
                {production_countries[0]?.name || "N/A"}{" "}
                <ReactCountryFlag
                  countryCode={production_countries[0]?.iso_3166_1 || "US"}
                />
              </div>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <span>{budget ? `$${budget.toLocaleString()}` : "N/A"}</span>
            </div>

            <div className="flex justify-between">
              <span className="font-bold text-gray-400">Revenue:</span>
              <span>{revenue ? `$${revenue.toLocaleString()}` : "N/A"}</span>
            </div>

            <div className="flex justify-between">
              <span className="font-bold text-gray-400">Review:</span>
              <span>{vote_average ? `${vote_average} / 10` : "N/A"}</span>
            </div>
          </div>
        </div>
